...
const DetalleProducto: React.FC = () => {
  ...
  // Inicializar stock local al cargar
  useEffect(() => {
  ...
  const agregarAlCarrito = () => {
    ...
    // 1. Actualizar el Carrito (localStorage)
    ...
    if (itemExistenteIndex > -1) {
      ...
      carrito.push({
        ...
        cantidad: cantidad,
        stock: producto.stock, // Stock inicial (referencia)
      });
    }
    localStorage.setItem("carrito", JSON.stringify(carrito));

    // 2. Actualizar el Stock (sessionStorage)
